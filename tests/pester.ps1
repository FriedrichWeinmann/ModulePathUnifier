...
Remove-Module ModulePathUnifier -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\ModulePathUnifier\ModulePathUnifier.psd1"
Import-Module "$PSScriptRoot\..\ModulePathUnifier\ModulePathUnifier.psm1" -Force
