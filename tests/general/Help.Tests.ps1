...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\ModulePathUnifier\functions", "$global:testroot\..\ModulePathUnifier\internal\functions"),
	
	[string]
	$ModuleName = "ModulePathUnifier",
...
$CommandPath = @(
    "$global:testroot\..\ModulePathUnifier\functions"
    "$global:testroot\..\ModulePathUnifier\internal\functions"
)
